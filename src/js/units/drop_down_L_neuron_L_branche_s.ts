...
export function drop_down_L_neuron_L_branche_s(parent_el: any){
                        ...
                        if(subclasses[0]){
                             if (subclasses[0].classList.contains("subclass")){
                                  ...
                                  for(let c = 0; c < subclasses.length; c++){
                                       let sub_L_CL = subclasses[c].classList;
                                       let sub_L_num_CL = subclasses_num[c].classList;
    
                                       if(sub_L_CL.contains("subclass")){
                                            sub_L_CL.remove("subclass");
                                            sub_L_num_CL.remove("subclass");
                                       }
                                  ...
                                  if(subclasses != null){
                                       for(let c = 0; c < subclasses.length; c++){
                                            ...
                                            let sub_L_num_CL = subclasses_num[c].classList;
                                            if(!sub_L_CL.contains("subclass")){
                                                 if(sub_L_CL.contains("class")){
                                                      sub_L_CL.remove("class");
                                                 }
                                                 sub_L_CL.add("subclass");
                                                 sub_L_num_CL.add("subclass");
                                            }
