...
function add_item(response_server_id, item_value, contenteditable){
...
document.addEventListener('DOMContentLoaded',function(){
   ...
   if(gEBI("create_new_channel_button")){
      gEBI("create_new_channel_button").addEventListener('click', async function() {
   ...
   function post_format(inner_text){
      let rows_arr = [];
