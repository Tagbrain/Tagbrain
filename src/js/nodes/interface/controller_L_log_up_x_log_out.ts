...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let log_up_L_element = gEBI("log_up");
    if(log_up_L_element instanceof Element){
        log_up_L_element.addEventListener("click", (e:any) => {
    ...
    function output_data_center_screen(data_output:any) {
        let output_container: HTMLElement = document.getElementById("logout_L_input_L_guide") as HTMLElement;
