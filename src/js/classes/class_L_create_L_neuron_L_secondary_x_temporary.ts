...
class class_L_create_L_neuron_L_secondary_x_temporary {
    constructor(){
        //define this
    ...
    get_channel_data_controller(){
        ...
        let controller_f = function(response_obj: any){
            if(response_obj.status == "success"){
                ...
                let obj00s_L_neuron00s = window["tagbrain_graph"]["neuron00s_obj00s"];
                if(obj00s_L_neuron00s["brain_data"] != undefined){
                    obj00s_L_neuron00s["brain_data"].hide_L_neuron();
                }
                let neuron_features = {
                ...
                focus_L_neuron_L_target_L_tab("brain_data", "settings");
...
export {class_L_create_L_neuron_L_secondary_x_temporary}