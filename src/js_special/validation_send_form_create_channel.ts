import { generate_c_graph_c_environment } from "../js/nodes/all_posts_action/generate_c_graph_c_environment";
import { gEBI } from "../js/units/compress_f";
import { class_L_controller_L_form } from "./class_L_controller_L_form";

let form_L_field00s = {
    neuron_c_nucleus_L_element: gEBI("form_c_create_c_channel") as Element,
    url_L_request: "php/neurons/controller_c_api.php",
    ...
    event_L_success_L_response: function(paramater00s: any){
        ...
        generate_c_graph_c_environment(paramater00s.graph_L_name_X_created);
    },
