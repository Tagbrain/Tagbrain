...
<div class="keyboard" id="marker_keyboard">
        <!-- 
		...
		<div class="tools_button_copy" copy_attr="[↓] " title="less">↓</div>
        <div class="tools_button_copy" copy_attr="#" title="Synapse operator">#</div>
        <div title="$" class="tools_button_copy" copy_attr="$">$</div>
	</div>
