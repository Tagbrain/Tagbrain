<div class="upper_layer_for_animation">	
	<div class="shadow_background_container_pos shadow_container_property">
		<div id="central_pop_up_block" class="central_pop_up_block">
			...
			<div class="settings_tabs_cont_pos">

				<div class="tab_right_bar">
					<input type="radio" id="general_pop_up" name="tab-group-1" checked="checked">

					<label class="menu_item_right_bar" for="general_pop_up" title="Draft">				
						<a class="a_cl" title="General">General</a>
					</label>
					<div class="settings_container" id="general_pop_up_container">
				...
				<div class="tab_right_bar">
					<input type="radio" id="this_channel_pop_up" name="tab-group-1">
				...
				<div class="tab_right_bar">
					<input type="radio" id="statistic_pop_up" name="tab-group-1">
...
<div class="bottom_layer_for_img_animation">
	<div class="background_svg_container">
		<svg class="background_svg" viewBox="0 0 1101.05 1049.06">
			<use xlink:href="#sprite_trigonometric_circle" class=""></use>
		</svg>
	</div>
</div>